...
int main() {
//    MyBD a;
//    std::string s = R"(CREATE TABLE Persons (
...
//
//    Result result = db.RequestQuery("SELECT * FROM Students");
//    //ASSERT_EQ(result.GetCounter(), 4);
//
//    result.Next();
////    ASSERT_EQ(result.Get("isu").GetIntVal(), 367124);
////    ASSERT_EQ(result.Get("name").GetStringVal(), "Nazar Vakulenko");
////    ASSERT_EQ(result.Get("points").GetDoubleVal(), 53.7);
////    ASSERT_EQ(result.Get("budget").GetBoolVal(), true);
//
//    result.Next();
////    ASSERT_EQ(result.Get("isu").GetIntVal(), 367111);
////    ASSERT_EQ(result.Get("name").GetStringVal(), "Petr Ivanov");
////    ASSERT_TRUE(result.Get("points").IsNull());
////    ASSERT_EQ(result.Get("budget").GetBoolVal(), true);
//
//    result.Next();
////    ASSERT_EQ(result.Get("isu").GetIntVal(), 367222);
////    ASSERT_EQ(result.Get("name").GetStringVal(), "Igor Meshechkin");
////    ASSERT_EQ(result.Get("points").GetDoubleVal(), 100);
////    ASSERT_TRUE(result.Get("budget").IsNull());
//
//    result.Next();
////    ASSERT_EQ(result.Get("isu").GetIntVal(), 367121);
////    ASSERT_EQ(result.Get("name").GetStringVal(), "Danil Kashirin");
////    ASSERT_TRUE(result.Get("points").IsNull());
////    ASSERT_EQ(result.Get("budget").GetBoolVal(), true);
////
...
//    Result result2 = db.RequestQuery("SELECT * FROM Students");
//    //ASSERT_EQ(result2.GetCounter(), 0);
//
//    MyBD db;
//
//    db.RequestParsing("CREATE TABLE Students ("
...
//    data_base.DownloadFrom("Test");
    ...
    db.RequestParsing("INSERT INTO Students(isu, name, points, budget) VALUES (1, 'Nazar Vakulenko', 53.7, true)");
    db.RequestParsing("INSERT INTO Students(isu, name, budget) VALUES (2, 'Petr Ivanov', 1)");
    db.RequestParsing("INSERT INTO Students(isu, name, points) VALUES (3, 'Igor Meshechkin', 100)");
    db.RequestParsing("INSERT INTO Students(isu, name, budget) VALUES (4, 'Danil Kashirin', true)");
    ...
    db.RequestParsing("INSERT INTO Food(id, customer_id, product) VALUES (3, 2, 'Sushi')");
    db.RequestParsing("INSERT INTO Food(id, customer_id, product) VALUES (4, 2, 'Sashimi')");
    db.RequestParsing("INSERT INTO Food(id, customer_id, product) VALUES (5, 5, 'RedBull')");
    db.RequestParsing("INSERT INTO Food(id, customer_id, product) VALUES (6, 5, 'Coffee')");
